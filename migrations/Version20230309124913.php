 ...
 */
final class Version20230309124913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande ADD statut_id INT DEFAULT NULL, DROP statut');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande ADD statut VARCHAR(255) NOT NULL, DROP statut_id');
    }
}
